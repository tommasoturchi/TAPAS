function addTriangularFittingPiece(haloPiecesCounter, haloIdNumber, outputShape, cost, op)
{
    ...
    /*
    if(outputShape == -1)
        addTextInDiv(fittingPiece, halfWidth, "10", "+10");
    else if(outputShape == 1)
        addTextInDiv(fittingPiece, halfWidth, "15", "-12");
    ...
    */
    ...
    var backgroundInnerTriangle = document.createElement("div");
    backgroundInnerTriangle.className = "background_inner_triangle " + containerClass;
    fittingPiece.appendChild(backgroundInnerTriangle);
    
    fittingPiece.className = fittingPiece.className + " " + triangularObstacle + " " + fittingPieceClass;
